					...
					<div class="columns clear">
						...
						<div class="col1-2 lastcol">
							...
							<tr>
								...
								<td><img src="<?php echo base_url("assets/admin"); ?>/images/ball_grey_16.png" class="block cr-help" alt="" title="Offline User"/></td>
								<td>Peter</td>
							</tr>
							<tr>
								<th>25/07/10</th>
								<td class="full"><a href="#">Consectetur adipiscing</a></td>
								<td><img src="<?php echo base_url("assets/admin"); ?>/images/ball_green_16.png" class="block cr-help" alt="" title="Online User"/></td>
								<td>Carla</td>
							</tr>
							<tr>
								<th>25/07/10</th>
					...
					<div class="columns clear bt-space15">
						<div class="col1-2 online-user">
							...
							<div class="mark clear">
								<div class="avatar">
									<img src="<?php echo base_url("assets/admin"); ?>/images/avatar.jpg" alt="" />
						...
						<div class="col1-2 lastcol">
							...
							<div class="mark icon-links">
								<ul>
								<li class="clear">
									<a href="#"><img src="<?php echo base_url("assets/admin"); ?>/images/ico_manage-users_48.png" class="icon" alt="" /><span>Manage Users &amp; Rights</span></a>
									<p><small>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed in porta lectus.</small></p>
								</li>
								<li class="clear">
									<a href="#"><img src="<?php echo base_url("assets/admin"); ?>/images/ico_book_48.png" class="icon" alt="" /><span>View Visit Book</span></a>
									<p><small>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed in porta lectus.</small></p>
								</li>
								<li class="lastlnk clear">
									<a href="#"><img src="<?php echo base_url("assets/admin"); ?>/images/ico_administration_48.png" class="icon" alt="" /><span>Administration of Orders</span></a>
									<p><small>Lorem ipsum dolor sit amet, consectetur adipiscing elit. Sed in porta lectus.</small></p>
								</li>
								</ul>
							</div>
					...
					<div id="data-table">
						...
						<tbody>
							<tr>
								...
								<td>
									<a href="#"><img src="<?php echo base_url("assets/admin"); ?>/images/ico_edit_16.png" class="icon16 fl-space2" alt="" title="edit" /></a>
									<a href="#"><img src="<?php echo base_url("assets/admin"); ?>/images/ico_delete_16.png" class="icon16 fl-space2" alt="" title="delete" /></a>
									<a href="#"><img src="<?php echo base_url("assets/admin"); ?>/images/ico_settings_16.png" class="icon16 fl-space2" alt="" title="settings" /></a>
								</td>
							</tr>
				...
				<div class="box-wrap clear">
					<div class="sidebar1-4 clear">
						...
						<div class="col3-4">
							...
							<tbody>
							<tr>
								<td><a href="#" title="preview"><img src="<?php echo base_url("assets/admin"); ?>/images/tmp/thumbnail1.jpg" alt="" class="thumb size48" /></a></td>
								...
								<td class="center vcenter"><img src="<?php echo base_url("assets/admin"); ?>/images/ico_active_16.png" class="icon16" title="active" alt="" /></td>
							</tr>
							<tr>
								<td><a href="#" title="preview"><img src="<?php echo base_url("assets/admin"); ?>/images/tmp/thumbnail2.jpg" alt="" class="thumb size48" /></a></td>
								...
								<td class="center vcenter"><img src="<?php echo base_url("assets/admin"); ?>/images/ico_inactive_16.png" class="icon16" title="inactive" alt="" /></td>
							</tr>
							<tr>
								<td><a href="#" title="preview"><img src="<?php echo base_url("assets/admin"); ?>/images/tmp/thumbnail3.jpg" alt="" class="thumb size48" /></a></td>
			...
			<div class="box-body">
				...
				<div class="box-wrap clear">
					...
					<tr>
						...
						<td><a href="#" class="quick_edit"><img src="<?php echo base_url("assets/admin"); ?>/images/ico_edit_16.png" alt="" class="icon16 fl" title="quick edit" /></a></td>
					</tr>
					<tr>
						<th>Pictures</th>
						<td><a href="<?php echo base_url("assets/admin"); ?>/images/tmp/picture1.jpg" title="preview" rel="group1"><img src="<?php echo base_url("assets/admin"); ?>/images/tmp/thumbnail1.jpg" alt="" class="thumb size64 fl-space" /></a>
						    <a href="<?php echo base_url("assets/admin"); ?>/images/tmp/picture2.jpg" title="preview" rel="group1"><img src="<?php echo base_url("assets/admin"); ?>/images/tmp/thumbnail2.jpg" alt="" class="thumb size64 fl-space" /></a>
						    <a href="<?php echo base_url("assets/admin"); ?>/images/tmp/picture3.jpg" title="preview" rel="group1"><img src="<?php echo base_url("assets/admin"); ?>/images/tmp/thumbnail3.jpg" alt="" class="thumb size64 fl-space" /></a></td>
					...
					<tr>
						<th>Status</th>
						<td class="edit-field edit-select"><img src="<?php echo base_url("assets/admin"); ?>/images/ico_inactive_16.png" class="icon16 fl" title="inactive" alt="" /></td>
						<td><a href="#" class="quick_edit"><img src="<?php echo base_url("assets/admin"); ?>/images/ico_edit_16.png" alt="" class="icon16 fl" title="quick edit" /></a></td>
					</tr>
					<tr>
