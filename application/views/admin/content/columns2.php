...
<title>TERMINATOR: Columns in Boxes</title>
		...
		<div class="menu">
			...
			<li class="active">
				...
				<ul>
					...
					<li class="active"><a href="columns.html">Columns</a>
						<ul>
							<li><a href="columns1.html">Boxes in Columns</a></li>
							<li class="active"><a href="columns2.html">Columns in Boxes</a></li>
						</ul>
					</li>
...
<div class="breadcrumb">
	<div class="bread-links pagesize">
		...
		<li><a href="#">Columns</a><span>&raquo;</span></li>
		<li><a href="#">Columns in Boxes</a></li>
		</ul>
	</div>
</div>
...
<div class="main pagesize"> <!-- *** mainpage layout *** -->
	<div class="main-wrap">
		<div class="page clear">
			<h1>Content Boxes with Columns inside</h1>
			<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat. Duis aute irure dolor in reprehenderit in voluptate velit esse cillum dolore eu fugiat nulla pariatur. Excepteur sint occaecat cupidatat non proident, sunt in culpa qui officia deserunt mollit anim id est laborum.</p>
			<p><strong>The codes are the same as the Single Columns, but this is the preview of Content Boxes where the columns are included inside of it.</strong></p>
			...
			<div class="box-body">
				<div class="box-header clear">
					<h2>Box with Half Columns inside</h2>
				</div>
			...
			<div class="box-body">
				<div class="box-header clear">
					<h2>Box with 1/3 Columns inside</h2>
				</div>
				<div class="box-wrap clear">
					<div class="columns clear">
						<div class="col1-3">
			...
			<div class="box-body">
				<div class="box-header clear">
					<h2>Box with 1/4 Columns inside</h2>
				</div>
				<div class="box-wrap clear">
					<div class="columns clear">
						<div class="col1-4">
			...
			<div class="box-body">
				<div class="box-header clear">
					...
					<h2>Columns in Content Box with Sidebar</h2>
				</div>
				<div class="box-wrap clear">
					<div id="tab01">
					<div class="code">&lt;div <span>class="sidebar1-4 clear"</span>&gt;</div>
					<div class="sidebar1-4 clear">
						<div class="sidebar">
							<div class="code">&lt;div <span>class="sidebar"</span>&gt;</div>
							<div class="sidemenu">
								<ul class="list">
						...
						<div class="col3-4">
							<div class="code">&lt;div <span>class="col3-4"</span>&gt;</div>
							
							<h3>Contents of Tab 1 with Sidebar 1/4</h3>
							<p>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</p>
							
							<div class="columns clear">
								<div class="code">&lt;div <span>class="columns clear"</span>&gt;</div>
								<div class="col1-2">
									<div class="code">&lt;div <span>class="col1-2"</span>&gt;</div>
									<h4>Half Column in Mainbar</h4>
								...
								<div class="col1-2 lastcol">
									<div class="code">&lt;div <span>class="col1-2 lastcol"</span>&gt;</div>
									<h4>Half Column in Mainbar</h4>
									<p class="block">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.</p>
								</div>
							</div>
							...
							<div class="columns clear">
								<div class="code">&lt;div <span>class="columns clear"</span>&gt;</div>
								<div class="col1-3">
									<div class="code">&lt;div <span>class="col1-3"</span>&gt;</div>
									<h4>1/3 Column in Mainbar</h4>
									<p class="block">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.</p>
								</div>
								<div class="col1-3">
									<div class="code">&lt;div <span>class="col1-3"</span>&gt;</div>
								...
								<div class="col1-3 lastcol">
									<div class="code">&lt;div <span>class="col1-3 lastcol"</span>&gt;</div>
									<h4>1/3 Column in Mainbar</h4>
									<p class="block">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.</p>
								</div>
							</div>
							...
							<div class="columns clear">
								...
								<div class="col2-3 lastcol">
									<div class="code">&lt;div <span>class="col2-3 lastcol"</span>&gt;</div>
									<h4>2/3 Column in Mainbar</h4>
									<p class="block">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.</p>
								</div>
							</div>
						</div>
					...
					<div id="tab02">
					<div class="code">&lt;div <span>class="sidebar1-3 clear"</span>&gt;</div>
					<div class="sidebar1-3 clear">
						...
						<div class="col2-3">
							<div class="code">&lt;div <span>class="col2-3"</span>&gt;</div>
							...
							<div class="columns clear">
								...
								<div class="col1-3">
									<div class="code">&lt;div <span>class="col1-3"</span>&gt;</div>
									<h4>Alternative Half Column in Mainbar</h4>
									<p class="block">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.</p>
								</div>
								<div class="col1-3 lastcol">
									<div class="code">&lt;div <span>class="col1-3 lastcol"</span>&gt;</div>
					...
					<div id="tab03">
					<div class="code">&lt;div <span>class="sidebar1-2 clear"</span>&gt;</div>
					<div class="sidebar1-2 clear">
						<div class="sidebar">
							...
							<div class="columns clear">
								...
								<div class="col1-2">
									<div class="code">&lt;div <span>class="col1-2"</span>&gt;</div>
									<h4>Half Column in Sidebar</h4>
									<p class="block"><small>Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco laboris nisi ut aliquip ex ea commodo consequat.</small></p>
								</div>
								<div class="col1-2 lastcol">
									<div class="code">&lt;div <span>class="col1-2 lastcol"</span>&gt;</div>
									<h4>Half Column in Sidebar</h4>
						...
						<div class="col1-2">
							...
							<div class="columns clear">
								<div class="code">&lt;div <span>class="columns clear"</span>&gt;</div>
								<div class="col1-4">
									<div class="code">&lt;div <span>class="col1-4"</span>&gt;</div>
									<h4>Alternative Half Column in Mainbar</h4>
									<p class="block">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.</p>
								</div>
								<div class="col1-4 lastcol">
									<div class="code">&lt;div <span>class="col1-4 lastcol"</span>&gt;</div>
									<h4>Alternative Half Column in Mainbar</h4>
									<p class="block">Lorem ipsum dolor sit amet, consectetur adipisicing elit, sed do eiusmod tempor incididunt ut labore et dolore magna aliqua. Ut enim ad minim veniam, quis nostrud exercitation ullamco.</p>
								</div>
							</div>
